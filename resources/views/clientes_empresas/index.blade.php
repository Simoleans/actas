@extends('layouts.app')
@section('title','Empresas - Cliente - '.config('app.name'))
@section('header','Empresas - Cliente')
@section('breadcrumb')
	<ol class="breadcrumb">
	  <li><a href="{{route('dashboard')}}"><i class="fa fa-home" aria-hidden="true"></i> Inicio</a></li>
	  <li class="active"> Empresas - Cliente </li>
	</ol>
@endsection
@section('content')
  ...
  <div class="row">
      ...
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">Empresas - Cliente</span>
	  	...
	  	<div class="col-md-12">
	    	<div class="box box-danger">
		      <div class="box-header with-border">
		        <h3 class="box-title"><i class="fa fa-users"></i> Empresas - Cliente</h3>
		        @if(Auth::user()->rol == 1)
			        <span class="pull-right">
						<a href="{{ route('clientese.create') }}" class="btn btn-flat btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Nueva Empresa</a>
					</span>
				@endif
		      </div>
      			<div class="box-body">
